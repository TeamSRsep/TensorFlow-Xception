...
parser.add_argument('config_path', help='path to and name of config (.ini) file See create_train_ini.py for more help')
args = parser.parse_args()
config = configparser.RawConfigParser()
config.read(args.config_path)
assert 'TRAIN' in config.sections(), '[TRAIN] section not found. See create_train_ini.py for help'
#================ DATASET INFORMATION ======================
...
items_to_descriptions = cfg['item_description']
...
learning_rate_decay_factor = float(cfg['learning_rate_decay_factor'])
num_epochs_before_decay = int(cfg['num_epochs_before_decay'])
